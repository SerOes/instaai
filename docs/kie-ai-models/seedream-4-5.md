...
# 4.5 Edit API Documentation

> Generate content using the 4.5 Edit model

## Overview

This document describes how to use the 4.5 Edit model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `seedream/4.5-edit` |
...
|----------|-------|-------------|
| **Format** | `seedream/4.5-edit` | The exact model identifier for this API |
...
- **Default Value**: `"Keep the model's pose and the flowing shape of the liquid dress unchanged. Change the clothing material from silver metal to completely transparent clear water (or glass). Through the liquid water, the model's skin details are visible. Lighting changes from reflection to refraction."`
...
- **Multiple Files**: Yes
- **Default Value**: `["https://static.aiquickdraw.com/tools/example/1764851484363_ScV1s2aq.webp"]`
...
```json
{
  ...
  "data": {
    ...
    "model": "seedream/4.5-edit",
    "state": "waiting",
    "param": "{\"model\":\"seedream/4.5-edit\",\"input\":{\"prompt\":\"Keep the model's pose and the flowing shape of the liquid dress unchanged. Change the clothing material from silver metal to completely transparent clear water (or glass). Through the liquid water, the model's skin details are visible. Lighting changes from reflection to refraction.\",\"image_urls\":[\"https://static.aiquickdraw.com/tools/example/1764851484363_ScV1s2aq.webp\"],\"aspect_ratio\":\"1:1\",\"quality\":\"basic\"}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1764851546720_u39KcdbX.webp\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
