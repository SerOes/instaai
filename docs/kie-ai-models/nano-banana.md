...
offizielle Docu: https://kie.ai/nano-banana

## Übersicht
- **Modell-ID**: `google/nano-banana`
...
GET https://api.kie.ai/api/v1/nano-banana/record-info?taskId={taskId}
```
...
- Kostengünstig (~$0.02 pro Bild)
- Natürliche Sprachbearbeitung
- Konsistente Ausgaben
- Präzisionskontrollierte Bearbeitung
- Realistische, physik-bewusste Ausgaben
