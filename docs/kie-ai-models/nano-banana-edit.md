# Nano Banana Edit API (Gemini 2.5 Flash Image - Editing)

offizielle Doku: https://kie.ai/model/google/nano-banana-edit.md

## Übersicht
- **Modell-ID**: `google/nano-banana-edit`
- **Anbieter**: Google DeepMind via KIE.ai
- **Typ**: Image Editing (Bild-Bearbeitung)
- **Pricing**: 4 credits pro Bild (~$0.02)

## API Endpoint
```
POST https://api.kie.ai/api/v1/nano-banana-edit/generate
GET https://api.kie.ai/api/v1/nano-banana-edit/record-info?taskId={taskId}
```
...
|-----------|-----|--------------|--------------|
| `prompt` | string | ✅ | Text-Beschreibung der gewünschten Bearbeitung |
| `image_urls` | array | ✅ | Liste der Eingabebilder (bis zu 10) |
| `output_format` | string | ❌ | Ausgabeformat: png, jpeg |
| `image_size` | string | ❌ | Seitenverhältnis/Größe |

## Unterstützte Image Sizes (Aspect Ratios)
- `1:1` - Quadrat
...
## Features
- Bis zu 10 Eingabebilder
- Natürliche Sprachbearbeitung
- Objektersetzung
- Hintergrundmodifikation
- Stil-Transformation
- Präzise Bearbeitungskontrolle

## Anwendungsfälle
- Objekte hinzufügen/entfernen
- Hintergründe ändern
- Stile transformieren
